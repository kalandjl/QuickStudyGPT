                ...
                <div className="container flex items-center justify-center pt-48 px-6 mx-auto">
                    <div className="w-full grid place-items-center">
                        ...
                        onSubmit={(e) => {
                            ...
                            mt-3 text-4xl font-extrabold capitalize sm:text-3xl dark:text-white">
                                Sign Up
                            </h1>
                            ...
                            <div className="relative flex items-center mt-8">
                                ...
                                dark:focus:border-${themeColor}-300 focus:ring-${themeColor}-300 
                            ...
                            <div className="relative flex items-center mt-4">
                                ...
                                className={`block w-full px-10 py-3 text-gray-700 bg-transparent border 
                            ...
                            <button 
                            type="submit"
                            className={`w-full mt-5 px-6 py-3 text-sm font-medium tracking-wide text-white 
                        ...
                        <div className="mt-6 w-full max-w-md">
                            ...
                            transition ease-in-out transform border rounded-lg 
                            hover:scale-105 hover:cursor-pointer bg-stone-800
